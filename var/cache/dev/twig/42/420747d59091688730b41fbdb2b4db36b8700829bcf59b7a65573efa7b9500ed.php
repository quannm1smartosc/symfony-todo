...
class __TwigTemplate_d29c86d5c50b26b75bbb11cc552dc6fb276ffab878fce75e5ec9bc416a24be26 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 11
        echo "    ";
        if ((isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 11, $this->source); })())) {
            // line 12
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                ...
                echo "</td>
                        <td>";
                // line 26
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "des", [], "any", false, false, false, 26), "html", null, true);
                echo "</td>
                        <td>
                            <a href=\"/article/";
                // line 28
                ...
                echo "\" class=\"btn btn-danger delete-article\">Delete</a>
                        </td>
                    </tr>
                ";
            }
    ...
    ";
            ...
            // line 37
            echo "    <p>No Todo Tasks to display</p>
    ";
        }
...
";
    ...
    {
        return array (  186 => 42,  176 => 41,  164 => 37,  159 => 34,  149 => 30,  145 => 29,  141 => 28,  136 => 26,  132 => 25,  128 => 24,  125 => 23,  121 => 22,  109 => 12,  106 => 11,  97 => 8,  94 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
                ...
                {% for article in articles %}
                    <tr>
                        ...
                        <td>
                            ...
                            <a href=\"/delete/{{ article.id }}\" class=\"btn btn-danger delete-article\">Delete</a>
                        </td>
                    </tr>
                {% endfor %}
            </tbody>
    ...
    {% else %}
    <p>No Todo Tasks to display</p>
    {% endif %}
{% endblock %}

{% block javascripts %}
    <script src=\"/js/main.js\"></script>
{% endblock %}", "articles/index.html.twig", "/home/krchaos/TodoList/templates/articles/index.html.twig");
    }
}
