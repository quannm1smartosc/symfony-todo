...
class __TwigTemplate_779e5cda334a4b5e8dba99770bddce2627bd7161fb3c70116c8febdcf86ab6c1 extends Template
{
    private $source;
    private $macros = [];
   ...
   <p> ";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 7, $this->source); })()), "des", [], "any", false, false, false, 7), "html", null, true);
        echo " </p>
   <hr>
   <a href=\"/\">Back</a>
";
...
{% block body %}
   ...
   <hr>
   <a href=\"/\">Back</a>
{% endblock %}", "articles/show.html.twig", "/home/krchaos/TodoList/templates/articles/show.html.twig");
    }
}
